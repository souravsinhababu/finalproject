...
<div class="wrapper col3">
  <div id="homecontent">
    <div class="fl_left">
      <div class="column2">
        <h2 style="color:#0000CC">FootBall KIT Delivery Entry !</h2>
        
		
		<center>
		<form id="form1" name="form1" method="post" action="Deliverydata.php">
		  <table cellpadding="4" style="width:50%; color:#660099; font-family:'Times New Roman', Times, serif; font-size:16px; font-weight:bold;" >
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
            </tr>
  ...
  <tr>
    <td>KIT ID </td>
    <td><input type="text" name="bid" value="<?php echo $row1['KitID']; ?>" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><input type="text" id="tprice"  name="tprice" value="<?php echo $row1['TotalPrice']; ?>" /></td>
            ...
            <tr>
              <td colspan="2" align="center"><input type="submit" name="Submit" value="Delivery" style="width:120px;height:30px; background-color:#0066FF; color:#FFFFFF"/></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
